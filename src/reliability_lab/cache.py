...
class ResponseCache:
    ...
    def set(self, query: str, value: str, metadata: dict[str, str] | None = None) -> None:
        ...
        Store a value after applying the privacy guardrail:
    ...
    def similarity(a: str, b: str) -> float:
        ...
        Uses cosine similarity over character n-grams and word tokens.
        ...
        def tokenize(text: str) -> list[str]:
            ...
            ngrams = [word[index : index + 3] for word in words for index in range(len(word) - 2)]
            return words + ngrams
        ...
        dot_product = sum(count * vector_b.get(token, 0) for token, count in vector_a.items())
...
class SharedRedisCache:
    ...
    Redis commands make cache state visible to multiple gateway instances.
